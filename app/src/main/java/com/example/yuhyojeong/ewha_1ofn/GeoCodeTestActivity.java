...
public class GeoCodeTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText et1 = (EditText)findViewById(R.id.textLat);
        final EditText et2 = (EditText)findViewById(R.id.textLong);
